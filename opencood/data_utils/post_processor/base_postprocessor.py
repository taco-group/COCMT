...
class BasePostprocessor(object):
    ...
    def generate_object_center(self,
                               ...
                               enlarge_z=False, multi_range_label_flag=False):
        """
        ...
        output_dict = {}
        if multi_range_label_flag and self.train:
            if cav_content['modality_name'] == 'm2':
                filter_range = self.params['anchor_args']['single_camera_ego_gt_range']
            elif cav_content['modality_name'] == 'm1':
                filter_range = self.params['anchor_args']['single_lidar_ego_gt_range']
        else:
    ...
    def generate_object_center_v2v4real(self,
        ...
        if np.array_equal(cav_content['params']['lidar_pose_clean'], reference_lidar_pose):
            transformation_matrix_clean = np.identity(4)
        else:
            transformation_matrix_clean = \
                x1_to_x2(cav_content['params']['lidar_pose_clean'],
                         reference_lidar_pose)
