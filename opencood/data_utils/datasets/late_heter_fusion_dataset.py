        ...
        def get_item_single_car(self, selected_cav_base):
            ...
            if sensor_type == "camera":
                ...
                for idx, img in enumerate(camera_data_list):
                    ...
                    #adj_camera_intrinsic = camera_intrinsic.copy()
                    #adj_camera_intrinsic[:2, :3] = post_rot2.numpy() @ adj_camera_intrinsic[:2, :3]
                    #adj_camera_intrinsic[:2, 2] = post_tran2.numpy() + adj_camera_intrinsic[:2, 2]
                    #intrin_augmted = torch.from_numpy(adj_camera_intrinsic)
                    ...
                    #intrins_augmted.append(intrin_augmted)
                    ...
                    f"image_inputs_{modality_name}":
                        {
                            ...
                            #"intrins_augmted": torch.stack(intrins_augmted),
        ...
        def collate_batch_test(self, batch):
            ...
            for cav_id, cav_content in batch.items():
                ...
                if sensor_type == 'camera':
                    ...
                    #intrins_augmted_batch = [cav_content[f"image_inputs_{modality_name}"]["intrins_augmted"]]
                    ...
                    lidar2cameras_batch = [cav_content[f"image_inputs_{modality_name}"]["lidar2cameras"]]
