...
class OPV2VBaseDataset(Dataset):
    ...
    def generate_object_center_lidar(self,
        ...
        return self.post_processor.generate_object_center(cav_contents,
                                                        reference_lidar_pose, multi_range_label_flag=multi_range_label_flag)
    ...
    def generate_object_center_camera(self,
        ...
        return self.post_processor.generate_visible_object_center(
            cav_contents, reference_lidar_pose, multi_range_label_flag=multi_range_label_flag
        )
    ...
    def get_lidar2camera(self, params, camera_id):
        # lidar2camera #
        lidar2camera = np.array(params["camera%d" % camera_id]["extrinsic"]).astype(
            np.float32)
        return lidar2camera
